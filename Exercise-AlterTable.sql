...
CREATE TABLE testing_table (name VARCHAR(10), contact_name VARCHAR(20), roll_no VARCHAR(10)); 

ALTER TABLE testing_table DROP name; 

ALTER TABLE testing_table CHANGE contact_name username CHAR(20);

ALTER TABLE testing_table ADD first_name VARCHAR(10), ADD last_name VARCHAR(10); 
